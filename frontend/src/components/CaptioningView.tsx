...
export default function CaptioningView({ screenStream }: CaptioningViewProps) {
  ...
  return (
    <div className="absolute inset-0 text-white">
      <div className="relative w-full h-full">
        ...
        <ScreenCapture isRunning={isLoopRunning} onToggleRunning={handleToggleLoop} error={error} />
