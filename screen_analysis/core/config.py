...
class Settings(BaseSettings):
    ...
    # Docker Ollama Settings (MAIN)  -- only main that connect ollama dockerize version
    ...
    # Local Ollama Settings (except main) -- except main all branches connect local ollama version
